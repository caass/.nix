...
let
  ...
  darwinConfig =
    ...
    let
      ...
      hostConfig = import (
        if builtins.pathExists ./${hostName}/default.nix then
          ./${hostName}
        else if builtins.pathExists ./${hostName}.nix then
          ./${hostName}.nix
        else
          throw "Couldn't find a file at ./${hostName}"
      ) args;
    in
    {
